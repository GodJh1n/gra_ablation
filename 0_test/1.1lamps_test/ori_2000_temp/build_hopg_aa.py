...
N_WIDTH_UNITS   = 25     # Units along armchair edge (~6 nm)
N_LENGTH_UNITS  = 15      # Units along zigzag edge (~6.4 nm)
C_C_BOND        = 1.44    # C–C bond length in Å
NUM_LAYERS      = 3       # Number of graphene layers
INTERLAYER_DZ   = 3.35    # Interlayer spacing in Å
BOTTOM_OFFSET   = 10.0    # 底层最低 z 偏移 (对应 LAMMPS 固定层阈值 12 Å)
VAC              = 300.0   # 真空厚度 in Å
OUTPUT_FILENAME = "hopg_init.data"
