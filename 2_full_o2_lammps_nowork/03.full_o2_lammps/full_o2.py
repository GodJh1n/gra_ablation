...
VAC             = 300.0   # Vacuum thickness in Å

# Oxygen FCC packing parameters:
O_CELL_CONST    = 7.0    # FCC lattice constant for O atoms (Å)
O_REP_XY        = 8      # Repetitions in x & y directions for O FCC
O_REP_Z         = 20      # Repetitions in z direction for O FCC
O_Z_CENTER      = 150.0   # Target z-coordinate for the CENTER of the O block (Å)
